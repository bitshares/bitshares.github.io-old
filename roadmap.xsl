  ...
  <xsl:template match="/">
    <html>
      <body>
        ...
        <div><center><small>Last edit: <xsl:value-of select="root/timestamp/month"/>-<xsl:value-of select="root/timestamp/day"/>-<xsl:value-of select="root/timestamp/year"/></small></center></div>
